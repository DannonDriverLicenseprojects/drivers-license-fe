...
const Input = (props) => {
    ...
    return (
        ...
        <span className="text-[#232323] text-base font-normal mb-2 flex w-full">{props.label} {props.error !="" && <p className="text-xs text-orange-700 ml-auto">{props.error}</p>}</span>
        <input
        name={props.name}
